#logic works upto a p size of 280 at 7 levels per group
library(MASS)
library(TExPosition)
library(ExPosition)
library(ggplot2)
...
source("VariableSelDummy/InternalFunc/plscaGPLSStep1.R")
source("VariableSelDummy/InternalFunc/plscaGPLSStep2.R")
source("VariableSelDummy/InternalFunc/rowNormsvs.R")
source("VariableSelDummy/InternalFunc/caSVD.R")
source("VariableSelDummy/InternalFunc/makeRowProfilesvs.R")
source("VariableSelDummy/InternalFunc/caNormvs.R")
...
p <- 50                        #No. of X variables
q <- 4                         #No. of Z variables
off.var <- 10                   #No. of variables not relevant
ncomp <- 2
...
res.dum.vs <- dummyGPLS(data1, data2, ncomp = 2, mode = "regression", keepX = (rep(p-off.var,p)), 
